...
class OdomConverter(object):
    ...
    def write_merged_bag(self, ego_bag_file, target_bag, ego_namespace, obj_namespace, ego_odom, obj_odom, start_time, end_time):
        ego_sensors=[]
        conn_map = {}
    ...
    def write_solo_bag(self, ego_bag_file, target_bag, ego_namespace, ego_odom, start_time, end_time):
        ego_sensors=[]
        conn_map = {}
    ...
    def process_data(self):
        ...
        if self.cfg["target"]["novatel"]:
            ...
            target_odom = self.nav2odom(target_data[target_topics[0]])
        ...
        write_merged_bag(ego_bag_file=ego_source, 
                 ...
                 obj_odom=pruned_target_odom,
                 start_time=start_time,
                 end_time=end_time)

        write_merged_bag(ego_bag_file=target_source, 
